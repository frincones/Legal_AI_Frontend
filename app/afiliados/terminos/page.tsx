...
const CLAUSES: { h: string; p: string }[] = [
  ...
  { h: "2. Comisión", p: "Ganas el 30% del valor de cada suscripción de pago atribuida a tu link, mientras el cliente permanezca suscrito, hasta por 12 meses por cliente (comisión recurrente). El porcentaje se calcula sobre el valor neto recibido por Jurovia. Jurovia puede ajustar el porcentaje para nuevas ventas notificándolo con antelación." },
